...
$.Widget.prototype = {
	...
	_constructClasses: function( element, keys, object ) {
		var i,
			full = [],
		...
		for ( i = 0; i < keyArray.length; i++ ) {
			...
			this.classObject[ keyArray[ i ] ].add( element );
	...
	_addClass: function( element, keys, extra, update ) {
		...
		extra = extra ? ( " " + extra ) : "";
		return element.addClass( this._constructClasses( element, keys, update ) + extra );
	},
